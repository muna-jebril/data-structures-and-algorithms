...
Write a function named getCourseKeys that takes in the 
courseInfo object and returns an array containing the keys for the courseInfo object.
...
Write a function named hasChildrenEntries that is similar to your
 hasChildrenValues function from challenge 3, but uses the data's entries instead of its values.
...
const hasChildrenEntries = (arr, character) => {
    ...
    let i =0; 
    arr.forEach(child=>{
        Object.entries(child).forEach(entty=>{
            
            if(entty[1]=== character){
